...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rack-test>.freeze, [">= 0.6.3", "~> 0.6"])
      ...
      s.add_runtime_dependency(%q<pact-support>.freeze, ["~> 1.7"])
      s.add_runtime_dependency(%q<pact-mock_service>.freeze, ["~> 2.10.0"])
      ...
      s.add_dependency(%q<pact-support>.freeze, ["~> 1.7"])
      s.add_dependency(%q<pact-mock_service>.freeze, ["~> 2.10.0"])
