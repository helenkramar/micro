# -*- encoding: utf-8 -*-
# stub: pact-provider-verifier 1.15.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pact>.freeze, ["~> 1.17"])
      s.add_runtime_dependency(%q<pact-message>.freeze, [">= 0.4.1", "~> 0.4"])
      ...
      s.add_dependency(%q<pact>.freeze, ["~> 1.17"])
      s.add_dependency(%q<pact-message>.freeze, [">= 0.4.1", "~> 0.4"])
